...
const ATOMIC_SELECTOR = ".aze-equation,.aze-mermaid,.aze-diagram,.aze-plot,.aze-chart,.aze-geometry,.aze-circuit,.aze-timing,.aze-formula,.aze-reaction,.aze-structure,figure,img";
/**
