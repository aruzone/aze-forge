...
import { AXIS_CHILD_FIELDS, AXIS_SCALES, BAR_FIELDS, CHART_SERIES_FIELDS_BY_KIND, CHART_SERIES_KINDS, CHART_TOP_LEVEL_FIELDS, CHART_TYPES, DOMAIN_FIELDS, FUNCTION_FIELDS, MAX_BAR_CATEGORIES, MAX_BINS, MAX_CHART_SERIES, MAX_HISTOGRAM_VALUES, MAX_LABEL_CHARS, MAX_PARAMETERS, MAX_PLOT_SERIES, MAX_POINTS_PER_SERIES, MAX_SAMPLES, PLOT_SERIES_KINDS, PLOT_TOP_LEVEL_FIELDS, POINT_FIELDS, POINT_SERIES_FIELDS, } from "./plot.js";
import { CONSTRUCTION_KINDS, FIELDS_BY_KIND as GEOMETRY_FIELDS_BY_KIND, GEOMETRY_BOUNDS_KEYS, GEOMETRY_HEADER_FIELDS, MARK_KINDS, MAX_COORDINATE_MAGNITUDE, MAX_EQUAL_MARK_GROUPS, MAX_EQUAL_MARK_SEGMENTS, MAX_GEOMETRY_DECLARATIONS, MAX_GEOMETRY_DIMENSION_PX, MAX_GEOMETRY_LABEL_CHARS, MAX_POLYGON_VERTICES, PRIMITIVE_KINDS, } from "./geometry.js";
import { BLOCK_FIELDS, DECLARATION_KINDS as CONTROL_DECLARATION_KINDS, EDGE_FIELDS as CONTROL_EDGE_FIELDS, FLOWS as CONTROL_FLOWS, HEADER_FIELDS as CONTROL_HEADER_FIELDS, MAX_CONTROL_BLOCKS, MAX_CONTROL_DECLARATIONS, MAX_CONTROL_EDGES, MAX_CONTROL_LABEL_CODE_POINTS, MAX_CONTROL_SIGNS_PER_SUM, MAX_CONTROL_STUBS, MAX_CONTROL_SUMS, MAX_CONTROL_TOTAL_LABEL_CODE_POINTS, SIGNS, STUB_FIELDS, SUM_FIELDS, } from "./control.js";
import { BOUNDS_KEYS, FIELDS_BY_KIND as FREE_BODY_FIELDS_BY_KIND, HEADER_FIELDS as FREE_BODY_HEADER_FIELDS, MAX_FREE_BODY_COORDINATE_MAGNITUDE, MAX_FREE_BODY_DECLARATIONS, MAX_FREE_BODY_DIMENSION_PX, MAX_FREE_BODY_LABEL_CHARS, MAX_FREE_BODY_POLYGON_VERTICES, MOMENT_DIRECTIONS, STYLES, } from "./free-body.js";
import { DECLARATION_KINDS as DIAGRAM_DECLARATION_KINDS, DIAGRAM_HEADER_FIELDS, EDGE_FIELDS as DIAGRAM_EDGE_FIELDS, FLOWS as DIAGRAM_FLOWS, GROUP_FIELDS as DIAGRAM_GROUP_FIELDS, DIRECTIONS, MAX_DIAGRAM_DECLARATIONS, MAX_DIAGRAM_EDGES, MAX_DIAGRAM_GROUPS, MAX_DIAGRAM_GROUP_DEPTH, MAX_DIAGRAM_LABEL_CODE_POINTS, MAX_DIAGRAM_LABEL_LINES, MAX_DIAGRAM_NODES, MAX_DIAGRAM_PARALLEL_EDGES, MAX_DIAGRAM_PORTS, MAX_DIAGRAM_PORTS_PER_NODE, MAX_DIAGRAM_TOTAL_LABEL_CODE_POINTS, MODES, NODE_FIELDS, PORT_FIELDS, SHAPES, SIDES, } from "./diagram.js";
import { ALT_FIELDS, ATTRIBUTE_FIELDS, CARDINALITIES, CLASS_ATTRIBUTE_FIELDS, CLASS_ITEM_FIELDS, CLASS_ITEM_KINDS, CLASS_RELATIONSHIP_FIELDS, CLASS_RELATIONSHIP_FORMS, DIVISION_FIELDS, ENTITY_ITEM_FIELDS, ENTITY_KEYS, ENTITY_RELATIONSHIP_FIELDS, LOOP_FIELDS, MAX_CLASS_ATTRIBUTES, MAX_CLASS_CLASSIFIERS, MAX_CLASS_OPERATIONS, MAX_CLASS_PARAMETERS, MAX_CLASS_RELATIONSHIPS, MAX_ENTITY_ATTRIBUTES, MAX_ENTITY_ENTITIES, MAX_ENTITY_RELATIONSHIPS, MAX_SEQUENCE_ALT_DIVISIONS, MAX_SEQUENCE_FRAGMENT_DEPTH, MAX_SEQUENCE_NOTE_SPAN, MAX_SEQUENCE_NOTE_TEXT_CHARS, MAX_SEQUENCE_NOTE_TEXT_LINES, MAX_SEQUENCE_PARTICIPANTS, MAX_SEQUENCE_TIMELINE_ITEMS, MAX_STATE_DEPTH, MAX_STATE_STATES, MAX_STATE_TRANSITIONS, MESSAGE_FIELDS, MESSAGE_FORMS, HEADER_FIELDS as MODELS_HEADER_FIELDS, MODELS_INTERFACE_FIELDS, MODELS_PSEUDO_STATE_FIELDS, NESTED_STATE_KINDS, NOTE_FIELDS, OPERATION_FIELDS, PARAMETER_FIELDS, PARTICIPANT_FIELDS, PARTICIPANT_KINDS, REFERENCE_FIELDS, RELATIONSHIP_END_FIELDS, SEQUENCE_SECTIONS, STATE_ITEM_FIELDS, TIMELINE_KINDS, TOP_LEVEL_STATE_KINDS, TRANSITION_FIELDS, VISIBILITIES, } from "./models.js";
import { ARROW_FIELDS, INTERVAL_FIELDS, MARKER_FIELDS, MAX_TIMING_ARROWS, MAX_TIMING_GROUPS, MAX_TIMING_GROUP_DEPTH, MAX_TIMING_INTERVALS, MAX_TIMING_MARKERS, MAX_TIMING_SIGNALS, MAX_TIMING_SPAN, MAX_TIMING_TEXT_CODE_POINTS, MAX_TIMING_TOTAL_INTERVALS, MAX_TIMING_WAVE_CHARS, MAX_TIMING_WIDTH, SCALE_WORDS, SIGNAL_FIELDS, TIMING_BODY_KINDS, STATE_WORDS, TIME_UNITS, GROUP_FIELDS as TIMING_GROUP_FIELDS, HEADER_FIELDS as TIMING_HEADER_FIELDS, } from "./timing.js";
import { FIELDS_BY_KIND as CIRCUIT_FIELDS_BY_KIND, FLOWS as CIRCUIT_FLOWS, HEADER_FIELDS as CIRCUIT_HEADER_FIELDS, CURRENT_DIRECTIONS, GATE_INPUTS, MAX_CIRCUIT_ANNOTATIONS, MAX_CIRCUIT_COMPONENTS, MAX_CIRCUIT_NODES, MAX_CIRCUIT_RELATIONS, MODE_VALUES, NODE_ROLES, ORIENTATIONS, } from "./circuit.js";
import { FORMULA_HEADER_FIELDS, REACTION_HEADER_FIELDS, STRUCTURE_HEADER_FIELDS, } from "./chemistry-schemas.js";
import { ATOM_FIELDS, BOND_FIELDS, ELEMENT_SYMBOLS, LABEL_FIELDS, MAX_FORMULA_CHARGE, MAX_FORMULA_EXPRESSION_CHARS, MAX_GROUP_NESTING, MAX_ISOTOPE_MASS, MAX_REACTION_CONDITION_CHARS, MAX_REACTION_SPECIES, MAX_REACTION_SPECIES_CHARS, MAX_STRUCTURE_ATOMS, MAX_STRUCTURE_HEIGHT, MAX_STRUCTURE_LABEL_CHARS, MAX_STRUCTURE_WIDTH, MAX_SUBSCRIPT, STRUCTURE_OPENERS, } from "./chemistry.js";
import { CALLOUT_HEADER_FIELDS, CALLOUT_VARIANTS, } from "./callout-schemas.js";
import { DERIVATION_HEADER_FIELDS, DERIVATION_STEP_FIELDS, } from "./derivation.js";
import { EQUATION_HEADER_FIELDS, MAX_EQUATION_SOURCE_LENGTH, MAX_EQUATION_TEX_LENGTH, } from "./equation.js";
import { FIGURE_HEADER_FIELDS, } from "./figure.js";
import { MAX_MERMAID_SOURCE_LENGTH, MAX_MERMAID_TEXT_LENGTH, MERMAID_HEADER_FIELDS, SUPPORTED_DIAGRAMS, } from "./mermaid.js";
import { MAX_TEX_BODY_LENGTH, TEX_HEADER_FIELDS } from "./tex.js";
import { TEX_PROFILES } from "./tex-schemas.js";
import { ALIGNMENTS, MAX_TABLE_COLUMNS, MAX_TABLE_GROUPS, MAX_TABLE_MATH_CELL_CHARS, MAX_TABLE_ROWS, MAX_TABLE_TEXT_CELL_CHARS, TABLE_COLUMN_FIELDS, TABLE_COLUMN_TYPES, TABLE_GROUP_FIELDS, } from "./table-parse.js";
import { BIBLIOGRAPHY_AUTHOR_FIELDS, BIBLIOGRAPHY_ENTRY_FIELDS, BIBLIOGRAPHY_ENTRY_TYPES, MAX_BIBLIOGRAPHY_ENTRIES, } from "./bibliography.js";
import { ALGORITHM_STATEMENT_KEYS, MAX_ALGORITHM_NESTING_DEPTH, MAX_ALGORITHM_PARAMETERS, MAX_ALGORITHM_STATEMENTS, MAX_PSEUDOCODE_EXPRESSION_LENGTH, } from "./algorithm.js";
import { MAX_STATEMENT_MARKDOWN_CHARS, STATEMENT_HEADER_FIELDS, STATEMENT_KINDS, } from "./statement.js";
import { MAX_EXAMPLE_GIVENS, MAX_EXAMPLE_MARKDOWN_CHARS, MAX_EXAMPLE_STEPS, REGISTERED_FIELDS, STEP_FIELDS, } from "./example.js";
/**
 ...
 */
export function fieldsFrom(keys, types, required = [], values = {}) {
...
export function fieldKeys(table, kind) {
...
export function headerFrom(keys, types, required = [], values = {}, groups = []) {
    return Object.freeze({
        separator: "----",
...
export function group(of, keys, types, required = [], values = {}) {
    return Object.freeze({
        of,
        fields: fieldsFrom(keys, types, required, values),
    });
...
export function sectionOf(of, records) {
    return Object.freeze({ of, records });
}
export function record(kind, fields, groups = []) {
    return Object.freeze({
        kind,
        fields,
        ...(groups.length === 0 ? {} : { groups }),
...
export function recordsFrom(kinds, fieldsByKind, types, required, values = {}, groups = {}) {
    return Object.freeze(kinds.map((kind) => {
        const keys = fieldsByKind[kind];
        if (keys === undefined) {
            throw new Error(`Grammar is missing a field table for record "${kind}".`);
        }
        return record(kind, fieldsFrom(keys, types, required[kind] ?? [], values), groups[kind] ?? []);
    }));
}
export function recordList(recordOpener, records, extra = {}) {
    return Object.freeze({
        form: "record-list",
        recordOpener,
        records,
...
export function scalarLines(fields, groups = []) {
    return Object.freeze({
        form: "scalar-lines",
        fields,
        ...(groups.length === 0 ? {} : { groups }),
...
export function keyedSections(fields, records = [], groups = []) {
    return Object.freeze({
        form: "keyed-sections",
        fields,
 ...
 */
const FRONT_MATTER_TYPES = Object.freeze({
    azemark: "integer",
    author: "string-list",
    title: "text",
    theme: "text",
...
const FRONT_MATTER_VALUES = Object.freeze({
 ...
 * Plot
 * ------------------------------------------------------------------ */
const plotAxisTypes = { label: "text", scale: "enum", min: "decimal", max: "decimal" };
const plotAxisValues = { scale: AXIS_SCALES };
...
const plotSpec = {
    header: headerFrom(PLOT_TOP_LEVEL_FIELDS, {
        id: "identifier",
        number: "boolean",
        width: "integer",
        height: "integer",
    ...
    body: recordList("-", recordsFrom(PLOT_SERIES_KINDS, { function: FUNCTION_FIELDS, line: POINT_SERIES_FIELDS, scatter: POINT_SERIES_FIELDS }, plotSeriesTypes, plotSeriesRequired, {}, plotSeriesGroups)),
    limits: {
...
const chartSpec = {
    header: headerFrom(CHART_TOP_LEVEL_FIELDS, {
        id: "identifier",
        number: "boolean",
        type: "enum",
        width: "integer",
        ...
        "y-min": "decimal",
        "y-max": "decimal",
    }, ["type"], { type: CHART_TYPES }),
    body: recordList("-", recordsFrom(CHART_SERIES_KINDS, CHART_SERIES_FIELDS_BY_KIND, chartSeriesTypes, chartSeriesRequired, {}, { bars: chartBarGroups })),
    limits: {
...
const GEOMETRY_HEADER_TYPES = Object.freeze({
    id: "identifier",
    number: "boolean",
    width: "integer",
    height: "integer",
...
const GEOMETRY_BOUNDS_TYPES = Object.freeze({
    "min-x": "decimal",
    "min-y": "decimal",
    "max-x": "decimal",
    "max-y": "decimal",
...
const GEOMETRY_KINDS = [...PRIMITIVE_KINDS, ...CONSTRUCTION_KINDS, ...MARK_KINDS];
const GEOMETRY_FIELD_TYPES = Object.freeze({
    kind: "enum",
    name: "identifier",
    label: "text",
    x: "decimal",
...
const GEOMETRY_REQUIRED = Object.freeze({
    point: ["kind", "name", "x", "y"],
...
const GEOMETRY_VALUES = Object.freeze({
    kind: GEOMETRY_KINDS,
    style: ["solid", "dashed"],
    direction: ["cw", "ccw"],
});
const GEOMETRY_RECORDS = [
    ...recordsFrom(PRIMITIVE_KINDS, GEOMETRY_FIELDS_BY_KIND, GEOMETRY_FIELD_TYPES, GEOMETRY_REQUIRED, GEOMETRY_VALUES),
    ...recordsFrom(CONSTRUCTION_KINDS, GEOMETRY_FIELDS_BY_KIND, GEOMETRY_FIELD_TYPES, GEOMETRY_REQUIRED, GEOMETRY_VALUES),
    ...
    ...recordsFrom(["equal-marks", "right-angle-mark"], GEOMETRY_FIELDS_BY_KIND, GEOMETRY_FIELD_TYPES, GEOMETRY_REQUIRED, GEOMETRY_VALUES),
];
const geometrySpec = {
 ...
 */
const controlSpec = {
    header: headerFrom(CONTROL_HEADER_FIELDS, {
        flow: "enum",
        id: "identifier",
        number: "boolean",
        title: "text",
    ...
    body: recordList("-", recordsFrom(CONTROL_DECLARATION_KINDS, {
        block: BLOCK_FIELDS,
        sum: SUM_FIELDS,
        input: STUB_FIELDS,
        output: STUB_FIELDS,
 ...
 */
const freeBodySpec = {
    header: headerFrom(FREE_BODY_HEADER_FIELDS, {
        scale: "decimal",
        id: "identifier",
        number: "boolean",
        title: "text",
    ...
    body: recordList("-", [
        record("block", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "block"), {
            name: "name",
            x: "decimal",
            y: "decimal",
            width: "decimal",
        ...
        record("circle", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "circle"), {
            name: "name",
            x: "decimal",
            y: "decimal",
            radius: "decimal",
        ...
        record("polygon", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "polygon"), {
            name: "name",
            vertices: "string-list",
            visible: "boolean",
        }, ["name", "vertices"])),
        record("particle", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "particle"), {
            name: "name",
            x: "decimal",
            y: "decimal",
            visible: "boolean",
        }, ["name", "x", "y"])),
        record("point", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "point"), {
            name: "name",
            x: "decimal",
            y: "decimal",
            label: "text",
        ...
        record("line", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "line"), {
            name: "name",
            from: "name",
            to: "name",
            visible: "boolean",
            style: "enum",
        }, ["name", "from", "to"], { style: STYLES })),
        record("force", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "force"), {
            at: "record",
            angle: "decimal",
            "parallel-to": "name",
        ...
        record("moment", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "moment"), {
            at: "record",
            direction: "enum",
            label: "text",
        }, ["at", "direction"], { direction: MOMENT_DIRECTIONS })),
        record("axes", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "axes"), {
            at: "record",
            angle: "decimal",
            "x-label": "text",
            "y-label": "text",
        }, ["at"])),
        record("angle-mark", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "angle-mark"), {
            first: "name",
            vertex: "name",
            third: "name",
            label: "text",
        }, ["first", "vertex", "third"])),
        record("dimension", fieldsFrom(fieldKeys(FREE_BODY_FIELDS_BY_KIND, "dimension"), {
            from: "record",
            to: "record",
            label: "text",
        }, ["from", "to", "label"])),
 ...
 */
const diagramSpec = {
    header: headerFrom(DIAGRAM_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        title: "text",
        description: "text",
        mode: "enum",
        flow: "enum",
    }, ["mode"], { mode: MODES, flow: DIAGRAM_FLOWS }),
    body: recordList("-", recordsFrom(DIAGRAM_DECLARATION_KINDS, { node: NODE_FIELDS, group: DIAGRAM_GROUP_FIELDS, edge: DIAGRAM_EDGE_FIELDS }, {
        name: "name",
        label: "text",
        shape: "enum",
        parent: "name",
        ...
        to: "name",
        direction: "enum",
    }, { node: ["name"], group: ["name"], edge: ["from", "to"] }, { shape: SHAPES, direction: DIRECTIONS }, {
        node: [
...
const MODELS_SEQUENCE_TIMELINE_RECORDS = recordsFrom(TIMELINE_KINDS, {
    message: MESSAGE_FIELDS,
    note: NOTE_FIELDS,
    alt: ALT_FIELDS,
    loop: LOOP_FIELDS,
}, MODELS_SEQUENCE_TYPES, MODELS_SEQUENCE_REQUIRED, MODELS_SEQUENCE_VALUES, {
...
const sequenceSpec = {
    ...
    body: keyedSections(fieldsFrom(SEQUENCE_SECTIONS, { participants: "record-list", timeline: "record-list" }, SEQUENCE_SECTIONS), [], [
        group(MODELS_SEQUENCE_PARTICIPANTS_SECTION, PARTICIPANT_FIELDS, MODELS_SEQUENCE_TYPES, ["name"], { kind: PARTICIPANT_KINDS }),
...
const MODELS_STATE_VALUES = { kind: TOP_LEVEL_STATE_KINDS };
...
const entitySpec = {
    header: MODELS_HEADER,
    body: recordList("-", recordsFrom(MODELS_ENTITY_ITEM_KINDS, {
        entity: ENTITY_ITEM_FIELDS,
        relationship: ENTITY_RELATIONSHIP_FIELDS,
    }, MODELS_ENTITY_TYPES, MODELS_ENTITY_REQUIRED, MODELS_ENTITY_VALUES, {
        entity: [
...
const classSpec = {
    header: MODELS_HEADER,
    body: recordList("-", recordsFrom(CLASS_ITEM_KINDS, {
        class: CLASS_ITEM_FIELDS,
        interface: MODELS_INTERFACE_FIELDS,
        relationship: CLASS_RELATIONSHIP_FIELDS,
    }, MODELS_CLASS_TYPES, MODELS_CLASS_REQUIRED, MODELS_CLASS_VALUES, {
        class: [
...
const timingSpec = {
    header: headerFrom(TIMING_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        title: "text",
        description: "text",
        scale: "enum",
        unit: "enum",
    }, ["title"], { scale: SCALE_WORDS, unit: TIME_UNITS }),
    body: recordList("-", recordsFrom(TIMING_BODY_KINDS, {
        ...
        duration: "decimal",
        value: "text",
    }, { signal: ["ref"], group: ["signals"], marker: ["at"], arrow: ["from", "to"] }, { state: STATE_VALUES }, {
        signal: [
            group("intervals", INTERVAL_FIELDS, { state: "enum", duration: "decimal", value: "text" }, ["state", "duration"], { state: STATE_VALUES }),
        ],
    })),
    limits: {
...
const circuitSpec = {
    header: headerFrom(CIRCUIT_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        title: "text",
        description: "text",
        flow: "enum",
    }, ["title"], { flow: CIRCUIT_FLOWS }),
    body: recordList("-", [
        record("node", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.node, DECLARATION_TYPES, ["ref"], { role: NODE_ROLES })),
        record("connect", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.connect, DECLARATION_TYPES, ["terminal", "node"])),
        record("voltage-label", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["voltage-label"], DECLARATION_TYPES, ["positive", "negative"])),
        record("current-label", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["current-label"], DECLARATION_TYPES, ["terminal", "direction"], {
            direction: CURRENT_DIRECTIONS,
        })),
        record("resistor", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.resistor, COMPONENT_TYPES, ["ref", "value"], COMPONENT_VALUES)),
        record("capacitor", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.capacitor, COMPONENT_TYPES, ["ref", "value"], COMPONENT_VALUES)),
        record("inductor", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.inductor, COMPONENT_TYPES, ["ref", "value"], COMPONENT_VALUES)),
        record("voltage-source", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["voltage-source"], COMPONENT_TYPES, ["ref", "value"], {
            ...COMPONENT_VALUES,
            mode: MODE_VALUES["voltage-source"],
        })),
        record("current-source", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["current-source"], COMPONENT_TYPES, ["ref", "value"], {
            ...COMPONENT_VALUES,
        ...
        record("switch", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.switch, COMPONENT_TYPES, ["ref"], {
            ...COMPONENT_VALUES,
            mode: MODE_VALUES.switch,
        })),
        record("dependent-source", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["dependent-source"], COMPONENT_TYPES, ["ref", "value"], {
            ...COMPONENT_VALUES,
        ...
        record("bjt", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.bjt, COMPONENT_TYPES, ["ref"], {
            ...COMPONENT_VALUES,
            mode: MODE_VALUES.bjt,
        })),
        record("mosfet", fieldsFrom(CIRCUIT_FIELDS_BY_KIND.mosfet, COMPONENT_TYPES, ["ref"], {
            ...COMPONENT_VALUES,
        ...
        record("mux-2to1", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["mux-2to1"], COMPONENT_TYPES, ["ref"], COMPONENT_VALUES)),
        record("mux-4to1", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["mux-4to1"], COMPONENT_TYPES, ["ref"], COMPONENT_VALUES)),
        record("d-flip-flop", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["d-flip-flop"], COMPONENT_TYPES, ["ref"], COMPONENT_VALUES)),
        record("digital-input", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["digital-input"], COMPONENT_TYPES, ["ref", "name"], COMPONENT_VALUES)),
        record("digital-output", fieldsFrom(CIRCUIT_FIELDS_BY_KIND["digital-output"], COMPONENT_TYPES, ["ref", "name"], COMPONENT_VALUES)),
    ]),
    limits: {
...
const formulaSpec = {
    header: headerFrom(FORMULA_HEADER_FIELDS, { id: "identifier", number: "boolean" }),
    body: scalarLines(fieldsFrom(["expression"], { expression: "expression" }, ["expression"])),
    limits: {
...
const reactionSpec = {
    header: headerFrom(REACTION_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        above: "text",
        below: "text",
    ...
    body: scalarLines(fieldsFrom(["equation"], { equation: "expression" }, ["equation"])),
    limits: {
...
const structureSpec = {
    header: headerFrom(STRUCTURE_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        width: "integer",
        height: "integer",
    ...
    body: recordList("-", [
        record(STRUCTURE_OPENERS[0], fieldsFrom(ATOM_FIELDS, {
            element: "enum",
            attach: "text",
            charge: "integer",
            isotope: "integer",
            at: "point-list",
            stereo: "enum",
        }, ["at"], { element: ELEMENT_SYMBOLS, stereo: ["unspecified"] })),
        record(STRUCTURE_OPENERS[1], fieldsFrom(BOND_FIELDS, { from: "name", to: "name", order: "enum", stereo: "enum" }, ["from", "to", "order"], { order: ["1", "2", "3", "aromatic"], stereo: ["wedge", "hash"] })),
        record(STRUCTURE_OPENERS[2], fieldsFrom(LABEL_FIELDS, { text: "text", at: "point-list" }, ["text", "at"])),
    ]),
    limits: {
 ...
 */
const equationSpec = {
    header: headerFrom(EQUATION_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        align: "enum",
        syntax: "enum",
...
const derivationSpec = {
    header: headerFrom(DERIVATION_HEADER_FIELDS, {
        id: "identifier",
        number: "boolean",
        align: "enum",
    }, [], {
    ...
    body: {
        ...scalarLines([]),
        records: [
            record("expression", fieldsFrom(DERIVATION_STEP_FIELDS, {
                expression: "expression",
                annotation: "prose",
            }, ["expression"])),
        ],
...
const figureSpec = {
    ...
    body: keyedSections(fieldsFrom(["children"], { children: "record-list" }, ["children"])),
    limits: {},
};
const calloutSpec = {
    header: headerFrom(CALLOUT_HEADER_FIELDS, {
        id: "identifier",
        variant: "enum",
        title: "prose",
    }, [], {
...
const mermaidSpec = {
    ...
    body: scalarLines(fieldsFrom(["source", "diagramType"], {
        source: "text",
        diagramType: "enum",
    }, ["source"], {
...
const TABLE_GROUP_FIELD_TYPES = {
    name: "text",
    columns: "string-list",
};
const BIBLIOGRAPHY_ENTRY_FIELD_TYPES = {
    key: "identifier",
    type: "enum",
    title: "text",
    authors: "record-list",
...
const BIBLIOGRAPHY_AUTHOR_FIELD_TYPES = {
    name: "text",
    family: "text",
};
const ALGORITHM_STATEMENT_FIELD_TYPES = {
    assign: "expression",
    if: "expression",
    for: "expression",
    while: "expression",
...
const EXAMPLE_FIELD_TYPES = {
    problem: "prose",
    givens: "string-list",
    steps: "record-list",
    result: "prose",
};
const EXAMPLE_STEP_FIELD_TYPES = {
    text: "prose",
};
/**
...
const tableSpec = {
    ...
    body: keyedSections(fieldsFrom(["columns", "groups", "rows"], { columns: "record-list", groups: "record-list", rows: "record-list" }, ["columns"]), [], [
...
const bibliographySpec = {
    ...
    body: recordList("-", [
        record("entry", fieldsFrom(BIBLIOGRAPHY_ENTRY_FIELDS, BIBLIOGRAPHY_ENTRY_FIELD_TYPES, [
            "key",
            "type",
            "title",
        ], { type: BIBLIOGRAPHY_ENTRY_TYPES }), [group("authors", BIBLIOGRAPHY_AUTHOR_FIELDS, BIBLIOGRAPHY_AUTHOR_FIELD_TYPES, ["name"])]),
    ]),
 ...
 */
const ALGORITHM_BLOCK_STATEMENTS = Object.freeze(["if", "for", "while"]);
const algorithmStepRecord = (key) => {
    const nested = ALGORITHM_BLOCK_STATEMENTS.includes(key)
        ? [
            sectionOf("do", ALGORITHM_STATEMENT_KEYS.map((word) => record(word, fieldsFrom([word], ALGORITHM_STATEMENT_FIELD_TYPES, [word])))),
        ]
        : [];
    const types = ALGORITHM_BLOCK_STATEMENTS.includes(key)
        ? { ...ALGORITHM_STATEMENT_FIELD_TYPES, do: "record-list" }
...
const ALGORITHM_STEP_RECORDS = ALGORITHM_STATEMENT_KEYS.map(algorithmStepRecord);
const algorithmSpec = {
    header: headerFrom(["id", "number", "caption"], {
        id: "identifier",
        number: "boolean",
    ...
    body: keyedSections(fieldsFrom(["procedure", "parameters", "steps"], { procedure: "name", parameters: "string-list", steps: "record-list" }, ["procedure", "steps"]), [], [sectionOf("steps", ALGORITHM_STEP_RECORDS)]),
    limits: {
...
const statementSpec = {
    header: headerFrom(["id", "number", "caption", ...STATEMENT_HEADER_FIELDS], { id: "identifier", number: "boolean", caption: "prose", kind: "enum" }, ["kind"], { kind: STATEMENT_KINDS }),
    body: keyedSections(fieldsFrom(["text", "proof"], { text: "prose", proof: "prose" }, ["text"])),
...
const exampleSpec = {
    ...
    body: keyedSections(fieldsFrom(REGISTERED_FIELDS, EXAMPLE_FIELD_TYPES, ["problem", "steps"]), [], [group("steps", STEP_FIELDS, EXAMPLE_STEP_FIELD_TYPES, ["text"])]),
    limits: {
 ...
 */
const DIRECTIVE_SPECS = Object.freeze({
...
function recordJsonSchema(record_) {
    const properties = {};
...
function bodyJsonSchema(type, body) {
...
const GRAMMAR_LIMITS = Object.freeze({
...
const GRAMMAR_DOCUMENT = Object.freeze({
    frontMatter: Object.freeze({
        delimiters: Object.freeze(["---"]),
        fields: fieldsFrom(Object.keys(KNOWN_METADATA_KEYS), FRONT_MATTER_TYPES, ["azemark"], FRONT_MATTER_VALUES),
    }),
...
export function grammarDirectiveTypes() {
    return Object.freeze(getBuiltInRegistry().plugins.map((plugin) => plugin.descriptor.type));
}
/**
 ...
 */
export function buildGrammarDocument(options = {}) {
    ...
    if (selected !== undefined &&
        ...
        throw new CompilerConfigurationError("azeforge.grammar#unknown-directive", `Directive "${selected}" is not a registered AzeMark 2 directive.`);
    }
    const directives = [];
    for (const plugin of registry.plugins) {
        const descriptor = plugin.descriptor;
        if (selected !== undefined && descriptor.type !== selected)
            continue;
        const spec = DIRECTIVE_SPECS[descriptor.type];
        if (spec === undefined) {
            throw new CompilerConfigurationError("azeforge.grammar#missing-directive", `Registered directive "${descriptor.type}" has no grammar description.`);
        }
    ...
    return Object.freeze({
        ...
        tool: Object.freeze({ name: "azeforge", version: TOOL_VERSION }),
        azemarkVersions: Object.freeze([2]),
...
export function serializeGrammar(report) {
