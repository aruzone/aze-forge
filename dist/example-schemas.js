...
export const EXAMPLE_PLUGIN_TYPE = "example";
export const EXAMPLE_PLUGIN_VERSION = "1.0.0";
export const EXAMPLE_BODY_SYNTAX_ID = "azeforge.example/v1";
export const EXAMPLE_BODY_SYNTAX_VERSION = "1.0.0";
export const exampleSourceSchema = Object.freeze({
...
export const exampleDataSchema = Object.freeze({
    $schema: "https://json-schema.org/draft/2020-12/schema",
