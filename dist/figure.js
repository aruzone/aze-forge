import { FIGURE_PLUGIN_TYPE, FIGURE_PLUGIN_VERSION, FIGURE_BODY_SYNTAX_ID, FIGURE_BODY_SYNTAX_VERSION, figureSourceSchema, figureDataSchema, } from "./figure-schemas.js";
 ...
 */
export const FIGURE_HTML_BLOCK_RENDERER_ID = "azeforge.figure.html/v1";
export const FIGURE_HTML_BLOCK_RENDERER_VERSION = "1.0.0";
/**
...
export const figurePlugin = Object.freeze({
...
export function renderFigureFragment(block, context) {
    ...
    return `<figure class="aze-figure">${caption}${context.renderBlocks(block.children)}</figure>`;
}
export const figureHtmlBlockRenderer = Object.freeze({
