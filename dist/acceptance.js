...
export const ACCEPTANCE_ENTRIES = Object.freeze([
    ...
    acceptanceEntry("P0-EQN-003", "p0", "equation", "Native mathematics grammar", "readable Source is compiled", [
    ...
    acceptanceEntry("P0-DRV-001", "p0", "derivation", "A derivation Block", "it is compiled", [
    ...
    acceptanceEntry("P0-PLT-001", "p0", "plot", "A native plot Block", "it is compiled", [
    ...
    acceptanceEntry("P0-PLT-002", "p0", "plot", "Invalid plot declarations and undefined regions", "they are compiled", [
    ...
    acceptanceEntry("P0-CHT-001", "p0", "chart", "A bar-family chart Block", "it is compiled", [
    ...
    acceptanceEntry("P0-GEO-001", "p0", "geometry", "A native geometry Block", "it is compiled", [
    ...
    acceptanceEntry("P0-GEO-002", "p0", "geometry", "Invalid geometry declarations and contradictory constraints", "they are compiled", [
    ...
    acceptanceEntry("P0-CHE-001", "p0", "chemistry", "Native formula, reaction, and structure Blocks", "they are compiled", [
    ...
    acceptanceEntry("P0-CHE-002", "p0", "chemistry", "Invalid or information-diminishing chemistry declarations", "they are compiled or normalized", [
    ...
    acceptanceEntry("P0-TIM-001", "p0", "timing", "Native timing Blocks over one shared cycle-or-time scale", "they are compiled", [
    ...
    acceptanceEntry("P0-TIM-002", "p0", "timing", "Invalid or over-limit timing declarations", "they are compiled", [
    ...
    acceptanceEntry("P0-DIA-001", "p0", "diagram", "Native general-diagram Blocks in the four registered modes", "they are compiled", [
    ...
    acceptanceEntry("P0-DIA-002", "p0", "diagram", "Invalid or over-limit diagram declarations", "they are compiled", [
    ...
    acceptanceEntry("P0-MOD-001", "p0", "models", "Native sequence, state, entity and class Blocks in one models Plugin family", "they are compiled", [
    ...
    acceptanceEntry("P0-MOD-002", "p0", "models", "Invalid or over-limit model declarations", "they are compiled", [
    ...
    acceptanceEntry("P0-ENG-001", "p0", "engineering", "Native control and free-body Blocks", "they are compiled", [
    ...
    acceptanceEntry("P0-ENG-002", "p0", "engineering", "Invalid or over-limit engineering declarations", "they are compiled", [
    ...
    acceptanceEntry("P0-STR-001", "p0", "structured-content", "Native typed tables, algorithms, statements with proofs and worked examples", "they are compiled", [
    ...
    acceptanceEntry("P0-STR-002", "p0", "structured-content", "Invalid or over-limit structured technical content", "they are compiled", [
    ...
    acceptanceEntry("P0-CMP-001", "p0", "composition", "Document numbering, references and the figure wrapper", "they are compiled", [
    ...
    acceptanceEntry("P0-CMP-002", "p0", "composition", "Citations, bibliography and endnote-rendered footnotes", "they are compiled", [
