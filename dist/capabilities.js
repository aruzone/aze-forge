...
import { MAX_CIRCUIT_ANNOTATIONS, MAX_CIRCUIT_COMPONENTS, MAX_CIRCUIT_NODES, MAX_CIRCUIT_RELATIONS, } from "./circuit.js";
import { MAX_TIMING_ARROWS, MAX_TIMING_GROUP_DEPTH, MAX_TIMING_GROUPS, MAX_TIMING_INTERVALS, MAX_TIMING_MARKERS, MAX_TIMING_SIGNALS, MAX_TIMING_SPAN, MAX_TIMING_TEXT_CODE_POINTS, MAX_TIMING_TOTAL_INTERVALS, MAX_TIMING_WAVE_CHARS, MAX_TIMING_WIDTH, } from "./timing.js";
import { MAX_DIAGRAM_DECLARATIONS, MAX_DIAGRAM_EDGES, MAX_DIAGRAM_GROUPS, MAX_DIAGRAM_GROUP_DEPTH, MAX_DIAGRAM_LABEL_CODE_POINTS, MAX_DIAGRAM_LABEL_LINES, MAX_DIAGRAM_NODES, MAX_DIAGRAM_PARALLEL_EDGES, MAX_DIAGRAM_PORTS, MAX_DIAGRAM_PORTS_PER_NODE, MAX_DIAGRAM_TOTAL_LABEL_CODE_POINTS, } from "./diagram.js";
import { TIMING_EMITTER_VERSION } from "./timing-render.js";
import { MAX_CLASS_ATTRIBUTES, MAX_CLASS_CLASSIFIERS, MAX_CLASS_OPERATIONS, MAX_CLASS_PARAMETERS, MAX_CLASS_RELATIONSHIPS, MAX_ENTITY_ATTRIBUTES, MAX_ENTITY_ENTITIES, MAX_ENTITY_RELATIONSHIPS, MAX_MODELS_NAME_CHARS, MAX_MODELS_TEXT_CHARS, MAX_SEQUENCE_ALT_DIVISIONS, MAX_SEQUENCE_FRAGMENT_DEPTH, MAX_SEQUENCE_NOTE_SPAN, MAX_SEQUENCE_NOTE_TEXT_CHARS, MAX_SEQUENCE_NOTE_TEXT_LINES, MAX_SEQUENCE_PARTICIPANTS, MAX_SEQUENCE_TIMELINE_ITEMS, MAX_STATE_DEPTH, MAX_STATE_STATES, MAX_STATE_TRANSITIONS, } from "./models.js";
import { MODELS_LAYOUT_VERSION, MODELS_WRAP_VERSION } from "./models-layout.js";
import { MAX_CONTROL_BLOCKS, MAX_CONTROL_DECLARATIONS, MAX_CONTROL_EDGES, MAX_CONTROL_LABEL_CODE_POINTS, MAX_CONTROL_SIGNS_PER_SUM, MAX_CONTROL_STUBS, MAX_CONTROL_SUMS, MAX_CONTROL_TOTAL_LABEL_CODE_POINTS, } from "./control.js";
import { MAX_FREE_BODY_COORDINATE_MAGNITUDE, MAX_FREE_BODY_DECLARATIONS, MAX_FREE_BODY_DIMENSION_PX, MAX_FREE_BODY_LABEL_CHARS, MAX_FREE_BODY_POLYGON_VERTICES, } from "./free-body.js";
...
import { MAX_EQUATION_SOURCE_LENGTH, MAX_EQUATION_TEX_LENGTH, } from "./equation.js";
import { EQUATION_LATEX_LANGUAGE_VERSION, KATEX_VERSION } from "./equation-schemas.js";
import { MAX_MERMAID_SOURCE_LENGTH, MAX_MERMAID_TEXT_LENGTH, } from "./mermaid.js";
...
import { MAX_COORDINATE_MAGNITUDE, MAX_EQUAL_MARK_GROUPS, MAX_EQUAL_MARK_SEGMENTS, MAX_GEOMETRY_DECLARATIONS, MAX_GEOMETRY_DIMENSION_PX, MAX_GEOMETRY_LABEL_CHARS, MAX_POLYGON_VERTICES, } from "./geometry.js";
import { MAX_FORMULA_CHARGE, MAX_FORMULA_EXPRESSION_CHARS, MAX_GROUP_NESTING, MAX_ISOTOPE_MASS, MAX_REACTION_CONDITION_CHARS, MAX_REACTION_SPECIES, MAX_REACTION_SPECIES_CHARS, MAX_STRUCTURE_ATOMS, MAX_STRUCTURE_HEIGHT, MAX_STRUCTURE_LABEL_CHARS, MAX_STRUCTURE_WIDTH, MAX_SUBSCRIPT, } from "./chemistry.js";
import { MAX_BAR_CATEGORIES, MAX_BINS, MAX_CHART_SERIES, MAX_HISTOGRAM_VALUES, MAX_LABEL_CHARS, MAX_PARAMETERS, MAX_PLOT_SERIES, MAX_POINTS_PER_SERIES, MAX_SAMPLES, } from "./plot.js";
import { CHROME_HEADLESS_SHELL_VERSION, resolvePinnedBrowserExecutable, } from "./mermaid-browser.js";
import { MAX_ALGORITHM_NESTING_DEPTH, MAX_ALGORITHM_PARAMETERS, MAX_ALGORITHM_STATEMENTS, MAX_PSEUDOCODE_EXPRESSION_LENGTH, } from "./algorithm.js";
import { MAX_STATEMENT_MARKDOWN_CHARS } from "./statement.js";
import { MAX_EXAMPLE_GIVENS, MAX_EXAMPLE_MARKDOWN_CHARS, MAX_EXAMPLE_STEPS, } from "./example.js";
import { MAX_TABLE_COLUMNS, MAX_TABLE_GROUPS, MAX_TABLE_MATH_CELL_CHARS, MAX_TABLE_ROWS, MAX_TABLE_TEXT_CELL_CHARS, } from "./table-parse.js";
import { MAX_BIBLIOGRAPHY_ENTRIES, MAX_FOOTNOTE_DEFINITIONS, MAX_LOCATOR_VALUE_LENGTH, MAX_REFERENCE_GROUP_TARGETS, MAX_REFERENCE_TOKENS, } from "./composition.js";
import { MAX_NESTING_DEPTH } from "./parse.js";
import { getBuiltInRegistry, validateRegistry } from "./registry.js";
import { HTML_MAX_BYTES, HTML_MIME_TYPE, HTML_PROFILE, HTML_SERIALIZER, } from "./render-html.js";
import { PDF_MAX_BYTES, PDF_MAX_HTML_BYTES, PDF_MAX_PAGES, PDF_MAX_TEMP_BYTES, PDF_MIME_TYPE, PDF_PROFILE, PDF_SERIALIZER, } from "./render-pdf.js";
import { PNG_MAX_BYTES, PNG_MAX_CSS_HEIGHT_PX, PNG_MAX_PIXEL_DIMENSION, PNG_MAX_PIXELS, PNG_DEVICE_SCALE_FACTOR, PNG_MIME_TYPE, PNG_PROFILE, PNG_SERIALIZER, } from "./render-png.js";
import { SVG_MAX_BYTES, SVG_MAX_HEIGHT_PX, SVG_MIME_TYPE, SVG_PROFILE, SVG_SERIALIZER, } from "./render-svg.js";
...
import { publicSchemaVersions } from "./version.js";
import { RUNTIME_SUPPORT } from "./runtime-support.js";
/** Eight commands in canonical blueprint order. */
export const CAPABILITY_COMMANDS = Object.freeze([
    {
        name: "render",
        summary: "Compile Source into one deterministic Artifact.",
        usage: "azeforge render <source> (--output <artifact> | --stdout --format <format>) [--format <format>] [--theme <theme>] [--allow-raw-latex] [--diagnostics json]",
    },
    {
        name: "validate",
    ...
    },
    {
        ...
        usage: "azeforge watch <source> --output <artifact> [--format <format>] [--theme <theme>] [--allow-raw-latex] [--diagnostics json]",
    },
    {
        name: "serve",
        summary: "Preview Source through a loopback preview server.",
        usage: "azeforge serve <source> [--port <port>] [--theme <theme>] [--allow-raw-latex] [--diagnostics json]",
    },
    {
        name: "format",
        summary: "Format Source deterministically.",
        usage: "azeforge format <source> [--write | --check] | azeforge format --stdin [--check] [--diagnostics json]",
    },
    {
        name: "capabilities",
    ...
    },
    {
        ...
        usage: "azeforge grammar [--json] [--directive <type>]",
    },
    {
        name: "version",
...
export const CAPABILITY_FORMATS = Object.freeze([
    "html",
    "svg",
    "png",
    "pdf",
]);
const BROWSER_UNAVAILABLE_REASON = `Pinned Chrome Headless Shell ${CHROME_HEADLESS_SHELL_VERSION} is unavailable.`;
const BROWSER_UNAVAILABLE_REMEDY = "Reinstall AzeForge browser dependencies to enable svg, png, pdf, and mermaid rendering; html rendering without diagrams remains available.";
/**
...
export async function buildCapabilities(options = {}) {
    ...
    const bundled = probe ? "available" : "unknown";
    return {
...
export function serializeCapabilities(report) {
