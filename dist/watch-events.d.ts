...
export declare const WATCH_EVENT_SCHEMA_ID: "azeforge.event/v1";
...
export declare function createStartedEvent(command: WatchCommand, seq: number, details: Omit<WatchStartedEvent, "schema" | "schemaVersion" | "tool" | "command" | "seq" | "kind">): WatchStartedEvent;
export declare function createResultEvent(command: WatchCommand, seq: number, details: Omit<WatchResultEvent, "schema" | "schemaVersion" | "tool" | "command" | "seq" | "kind">): WatchResultEvent;
export declare function createStoppedEvent(command: WatchCommand, seq: number, reason: string): WatchStoppedEvent;
export declare function serializeEvent(event: WatchEvent): string;
export {};
