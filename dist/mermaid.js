import { MERMAID_PLUGIN_TYPE, MERMAID_PLUGIN_VERSION, MERMAID_BODY_SYNTAX_ID, MERMAID_BODY_SYNTAX_VERSION, MERMAID_VERSION, mermaidSourceSchema, mermaidDataSchema, } from "./mermaid-schemas.js";
...
function headerFieldList(fields) {
...
const MERMAID_HEADER_FIELDS_SUGGESTION = `Valid mermaid attributes are ${headerFieldList(MERMAID_HEADER_FIELDS)}.`;
...
export function parseMermaidHeader(entries, _blockRange, sourceName) {
    ...
    for (const entry of entries) {
        if (!MERMAID_HEADER_FIELDS.includes(entry.key)) {
