...
export type LocatorWord = "page" | "pages" | "chapter" | "section" | "line" | "lines" | "note";
...
export type Inline = TextInline | EmphasisInline | StrongInline | CodeInline | LinkInline | ImageInline | BreakInline | ReferenceInline | ReferenceGroupInline | FootnoteInline;
...
export type TableColumnType = "prose" | "text" | "integer" | "decimal" | "quantity" | "boolean" | "math";
...
export type TypedTableCell = {
    readonly kind: "prose";
    readonly value: readonly Inline[];
} | {
    readonly kind: "text";
    readonly value: string;
} | {
...
export type CircuitTextRun = {
    readonly kind: "text" | "subscript" | "superscript";
    readonly value: string;
} | {
    readonly kind: "quantity";
    readonly coefficient: string;
...
export type CircuitComponentKind = "resistor" | "capacitor" | "inductor" | "voltage-source" | "current-source" | "diode" | "led" | "switch" | "dependent-source" | "op-amp" | "bjt" | "mosfet" | "and" | "or" | "nand" | "nor" | "xor" | "xnor" | "not" | "buffer" | "mux-2to1" | "mux-4to1" | "d-flip-flop" | "digital-input" | "digital-output";
export interface CircuitNode {
    readonly ref: string;
    readonly role: "signal" | "reference";
...
export interface CircuitComponent {
    ...
    readonly inputs?: 2 | 3 | 4;
    readonly name?: CircuitText;
...
export type CircuitAnnotation = {
    readonly kind: "voltage-label";
    readonly positive: string;
    readonly negative: string;
    readonly range: SourceRange;
} | {
    readonly kind: "current-label";
    readonly componentRef: string;
    readonly terminal: string;
    readonly direction: "into" | "out";
    readonly range: SourceRange;
};
...
export type TimingIntervalState = "low" | "high" | "unknown" | "impedance" | "bus" | "continue" | "rise" | "fall";
...
export type DiagramShape = "rectangle" | "rounded" | "diamond" | "parallelogram" | "circle" | "hexagon" | "cylinder";
...
export type DiagramFlow = "top-to-bottom" | "bottom-to-top" | "left-to-right" | "right-to-left";
...
export interface SequenceBlock {
    ...
    readonly id?: string;
    readonly number?: boolean;
    readonly title?: ModelsText;
    readonly description?: ModelsText;
...
export type ClassRelationshipForm = "inheritance" | "implementation" | "association" | "aggregation" | "composition";
...
export type ControlFlow = "top-to-bottom" | "bottom-to-top" | "left-to-right" | "right-to-left";
...
export type ControlDeclaration = ControlBlockItem | ControlSumItem | ControlStubItem | ControlEdgeItem;
...
export type FreeBodyDirection = {
    ...
    readonly kind: "parallel-to";
    readonly line: string;
} | {
    readonly kind: "perpendicular-to";
    readonly line: string;
};
...
export type FreeBodyBody = FreeBodyBoxBody | FreeBodyCircleBody | FreeBodyPolygonBody | FreeBodyParticleBody;
...
export type FreeBodyDeclaration = FreeBodyBody | FreeBodyPoint | FreeBodyLine | FreeBodyForce | FreeBodyMoment | FreeBodyAxes | FreeBodyAngleMark | FreeBodyDimension;
...
export type AlgorithmStatementKind = "assign" | "if" | "for" | "while" | "return" | "text";
/**
...
export type AlgorithmStatement = AlgorithmAssignStatement | AlgorithmIfStatement | AlgorithmForStatement | AlgorithmWhileStatement | AlgorithmReturnStatement | AlgorithmTextStatement;
...
export type StatementKind = "theorem" | "definition" | "lemma" | "corollary" | "proposition" | "remark";
...
export type BibliographyEntryType = "article" | "book" | "chapter" | "report" | "thesis" | "web" | "software" | "standard" | "other";
...
export type ParsedBlock = HeadingBlock | ParagraphBlock | ThematicBreakBlock | BlockquoteBlock | ListBlock | CodeBlock | TableBlock | CalloutBlock | EquationBlock | MermaidBlock | TexBlock | DerivationBlock | PlotBlock | ChartBlock | GeometryBlock | FormulaBlock | ReactionBlock | StructureBlock | TimingBlock | DiagramBlock | SequenceBlock | StateBlock | EntityBlock | ClassBlock | CircuitBlock | ControlBlock | FreeBodyBlock | AlgorithmBlock | StatementBlock | ExampleBlock | FigureBlock | BibliographyBlock | FootnoteDefinitionBlock | InvalidBlock;
export type AzeBlock = HeadingBlock | ParagraphBlock | ThematicBreakBlock | BlockquoteBlock | ListBlock | CodeBlock | TableBlock | CalloutBlock | EquationBlock | MermaidBlock | TexBlock | DerivationBlock | PlotBlock | ChartBlock | GeometryBlock | FormulaBlock | ReactionBlock | TimingBlock | DiagramBlock | SequenceBlock | StateBlock | EntityBlock | ClassBlock | CircuitBlock | StructureBlock | ControlBlock | FreeBodyBlock | AlgorithmBlock | StatementBlock | ExampleBlock | FigureBlock | BibliographyBlock | FootnoteDefinitionBlock;
...
export interface SvgArtifactMetadata extends ArtifactMetadataBase {
    ...
    readonly pixelDimensions: Readonly<{
        width: number;
        height: number;
    }>;
...
export type ArtifactMetadata = HtmlArtifactMetadata | SvgArtifactMetadata | PngArtifactMetadata | PdfArtifactMetadata;
...
export interface EquationBlockRenderer {
    ...
    readonly render: (block: EquationBlock, context: Readonly<{
        sourceName?: string;
    }>) => string | Promise<string>;
}
export type TexRendererFailureCategory = "adapter-unavailable" | "timeout" | "resource-limit" | "sandbox-denied" | "compile-failed" | "protocol-invalid";
/** Versioned batch protocol spoken over stdin/stdout by a TeX renderer command. */
export declare const TEX_RENDERER_PROTOCOL: "azeforge.tex-renderer/v1";
/** Maximum UTF-8 request bytes the batch protocol accepts. */
export declare const TEX_RENDER_REQUEST_MAX_BYTES = 1048576;
/** Maximum UTF-8 response bytes the compiler accepts from a TeX renderer command. */
export declare const TEX_RENDER_RESPONSE_MAX_BYTES = 8388608;
...
export interface MermaidBlockRenderer {
    readonly descriptor: BlockRendererDescriptor;
    readonly render: (block: MermaidBlock, context: Readonly<{
        sourceName?: string;
        ordinal?: number;
        theme?: Theme;
    }>) => string | Promise<string>;
