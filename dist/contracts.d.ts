 ...
 * browser compilation.
 */
export type { AnyBlockRenderer, Artifact, ArtifactHash, ArtifactFormat, ArtifactMetadata, AssetManifestEntry, AzeBlock, AzeBlockPlugin, AzeBlockRenderer, AzeDocument, BlockRendererContext, BlockRendererDescriptor, BlockquoteBlock, BreakInline, CalloutBlock, ChartBar, ChartBarSeries, ChartBlock, ChartHistogramSeries, ChartSeries, GeometryBlock, GeometryBounds, GeometryDeclaration, CodeBlock, CodeInline, ContentHash, DerivationBlock, DerivationStep, DocumentMetadata, EmphasisInline, EquationBlock, EquationBlockRenderer, BlockRenderer, HeadingBlock, HtmlArtifactMetadata, MermaidBlock, MermaidBlockRenderer, ImageInline, Inline, InvalidBlock, JsonPrimitive, JsonValue, LinkInline, ListBlock, ListItem, ParsedBlock, ParagraphBlock, ParsedDocument, PluginDescriptor, PdfArtifactMetadata, PlotAxisConfig, PlotBlock, PlotDataPoint, PlotFunctionSeries, PlotPointSeries, PlotSeries, PngArtifactMetadata, RelatedLocation, RendererDescriptor, Sha256Hash, SourcePosition, SourceRange, StrongInline, TableAlignment, TableBlock, TableColumn, TableData, TableGroup, TextInline, ThematicBreakBlock, Theme, TypedTableData, TypedTableCell, TexBlock, TexRenderer, TexRendererFailureCategory, TexRenderFigureRequest, TexRenderRequest, TexRenderResponse, TexRenderResult, TexRenderDiagnostic, TexBodyLocation, SvgArtifactMetadata, } from "./model.js";
...
export type { TexFigureFragmentOptions, TexSvgProjectionOptions, TexSvgRejection, } from "./tex-svg.js";
...
export type { AcceptanceCatalogDocument, AcceptanceEntry, AcceptanceEvidence, AcceptanceGate, } from "./acceptance.js";
export { WATCH_EVENT_SCHEMA_ID } from "./watch-events.js";
export type { WatchCommand, WatchEvent, WatchEventKind, WatchResultEvent, WatchStartedEvent, WatchStoppedEvent, } from "./watch-events.js";
...
export { TEX_BODY_SYNTAX_ID, TEX_BODY_SYNTAX_VERSION, TEX_PLUGIN_TYPE, TEX_PLUGIN_VERSION, TEX_PROFILES, type TexProfile, texDataSchema, texSourceSchema, } from "./tex-schemas.js";
