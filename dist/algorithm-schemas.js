...
export const ALGORITHM_PLUGIN_TYPE = "algorithm";
export const ALGORITHM_PLUGIN_VERSION = "1.0.0";
export const ALGORITHM_BODY_SYNTAX_ID = "azeforge.algorithm/v1";
export const ALGORITHM_BODY_SYNTAX_VERSION = "1.0.0";
export const algorithmSourceSchema = Object.freeze({
...
export const algorithmDataSchema = Object.freeze({
    $schema: "https://json-schema.org/draft/2020-12/schema",
...
//# sourceMappingURL=algorithm-schemas.js.map